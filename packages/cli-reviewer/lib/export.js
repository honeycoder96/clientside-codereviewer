 ...
 * @param {Map<string,object>}  fileReviews — Map<filename, FileReview>
 * @param {object[]}            files       — FileDiff[]
 * @returns {string}
 */
export function toMarkdown(diffReview, fileReviews, files) {
  ...
  lines.push(`> Generated by cr-reviewer (Ollama) · ${new Date().toISOString()}`)
  lines.push('')
  lines.push(
...
export function toSARIF(fileReviews) {
  const RULES = {
    bug: {
      ...
      helpUri: 'https://github.com/AESiR-0/webgpu-llm',
    ...
    runs: [
      {
        tool: {
          driver: {
            name:           'cr-reviewer',
            version:        '0.1.0',
            informationUri: 'https://github.com/AESiR-0/webgpu-llm',
            rules,
          },
        },
        results,
...
export function toPRDescription(diffReview, fileReviews, files) {
  ...
  lines.push('---')
  lines.push('*Generated by [cr-reviewer](https://github.com/AESiR-0/webgpu-llm) — local AI review powered by Ollama.*')
